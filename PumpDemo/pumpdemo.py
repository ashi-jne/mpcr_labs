...
def htmldoc(water_pump_status, air_pump_status,Shutdown_status):
    return f'''
        <html>
            <head>
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <br>
                    <a href="/toggle/Shutdown">
                        <button class="{('on' if Shutdown_status == 'ON' else 'off')}" style="width:200px;">
                            System Shutdown: {Shutdown_status}
                        </button>
                    </a>
...
def control(request):
    return htmldoc(
        ...
        'ON' if system_state['Shutdown'] else 'OFF'
    )
